...
const FALLBACK_SVG_BY_PROJECT_NAME: Record<string, string> = {
  ...
  "jeu-concours": POKEBALL_ICON_SVG,
  "jeu-concours-bardakoff": POKEBALL_ICON_SVG,
};
